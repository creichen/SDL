...
#define SDL_PEN_AXIS_XTILT        1 /**< Pen horizontal tilt fraction.  Bidirectional: -1.0..1.0 (left-to-right).  This is NOT the angle, but the tilt vector x component.  The physical max/min tilt may be smaller than -1.0 / 1.0, cf. \link SDL_PenCapabilityInfo \endlink .  */
#define SDL_PEN_AXIS_YTILT        2 /**< Pen vertical tilt fraction.  Bidirectional: -1.0..1.0 (top-to-bottom).  This is NOT the angle, but the tilt vector y component.  */
#define SDL_PEN_AXIS_DISTANCE     3 /**< Pen distance to drawing surface.  Unidirectional: 0.0..1.0 */
#define SDL_PEN_AXIS_ROTATION     4 /**< Pen barrel rotation.  Unidirectional: -0..1.0 (clockwise, 0 is facing up).  Multiply with "2.0 * M_PI" to get radians, or "360.0" for degrees. */
#define SDL_PEN_AXIS_SLIDER       5 /**< Pen finger wheel or slider (e.g., Airbrush Pen).  Unidirectional: 0..1.0 */

#define SDL_PEN_AXIS_LAST         SDL_PEN_AXIS_SLIDER   /**< Last valid axis index */
