...
SDL_DYNAPI_PROC(int,SDL_NumPens,(void),(),return)
SDL_DYNAPI_PROC(SDL_PenID,SDL_PenIDForIndex,(int a),(a),return)
SDL_DYNAPI_PROC(SDL_PenID,SDL_PenIDForGUID,(SDL_PenGUID a),(a),return)
SDL_DYNAPI_PROC(SDL_PenGUID,SDL_PenGUIDForPenID,(SDL_PenID a),(a),return)
SDL_DYNAPI_PROC(int,SDL_PenGUIDCompare,(SDL_PenGUID a, SDL_PenGUID b),(a,b),return)
SDL_DYNAPI_PROC(void,SDL_PenStringForGUID,(SDL_PenGUID a, char *b, int c),(a,b,c),)
...
SDL_DYNAPI_PROC(Uint32,SDL_PenCapabilities,(SDL_PenID a),(a),return)
